...
class Order extends CI_Controller
{
	...
	public function vue_list2()
	{
	    ...
	    $request = $this->order->lists();
	    $searchForm['action_url']   = '/order/vue_list2';
	    
	    $contents = $this->load->view('/order/vue_list2', array('request' => $request, 'searchForm' => $searchForm), TRUE);
	    //$contents .= $this->load->view('/pagelist/pagelist_v', '', TRUE);
	    
	    $this->load->view('/layout', array('contents' => $contents));
	}
	
	public function vue_list3()
	{
	    $searchForm = $this->input->post();
	    ...
	    $request = $this->order->lists();
	    $searchForm['action_url']   = '/order/vue_list3';
	    
	    $contents = $this->load->view('/order/vue_list3', array('request' => $request, 'searchForm' => $searchForm), TRUE);
	    //$contents .= $this->load->view('/pagelist/pagelist_v', '', TRUE);
	    
	    $this->load->view('/layout', array('contents' => $contents));
	}
	
	public function vue_list4()
	{
	    $searchForm = $this->input->post();
	    ...
	    $request = $this->order->lists();
	    $searchForm['action_url']   = '/order/vue_list4';
	    
	    $contents = $this->load->view('/order/vue_list4', array('request' => $request, 'searchForm' => $searchForm), TRUE);
	    //$contents .= $this->load->view('/pagelist/pagelist_v', '', TRUE);
