...
class Member extends CI_Controller
{
	...
	public function user_lists()
	{
	    ...
	    $request = $this->member->lists($searchForm);
	    ...
	    $searchForm['action_url']   = '/member/user_lists';
	    
	    $contents = $this->load->view('/member/user_lists', array('request' => $request, 'searchForm' => $searchForm), TRUE);
